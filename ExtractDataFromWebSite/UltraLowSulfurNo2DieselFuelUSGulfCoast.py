...
driver.get("https://www.eia.gov/dnav/pet/hist/EER_EPD2DXL0_PF4_RGC_DPGD.htm")


product="Ultra-Low-Sulfur No.2 Diesel Fuel"
area="U.S. Gulf Coast"
...
df.to_csv(r'C:/Users/User/Desktop/UltraLowSulfurNo2DieselFuelUSGulfCoast.csv', index=False, encoding='utf-8')
