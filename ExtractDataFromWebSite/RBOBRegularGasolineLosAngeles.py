...
driver.get("https://www.eia.gov/dnav/pet/hist/EER_EPMRR_PF4_Y05LA_DPGD.htm")
...
df.to_csv(r'C:/Users/User/Desktop/RBOBRegularGasolineLosAngeles.csv', index=False, encoding='utf-8')
