...
driver.get("https://www.eia.gov/dnav/pet/hist/EER_EPD2DC_PF4_Y05LA_DPGD.htm")
...
df.to_csv(r'C:/Users/User/Desktop/UltraLowSulfurNo2DieselFuelLosAngeles.csv', index=False, encoding='utf-8')
