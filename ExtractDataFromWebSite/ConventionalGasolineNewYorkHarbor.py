...
driver.get("https://www.eia.gov/dnav/pet/hist/EER_EPMRU_PF4_Y35NY_DPGD.htm")


product="Conventional Gasoline"
area="New York Harbor, Regular"
...
df.to_csv(r'C:/Users/User/Desktop/ConventionalGasolineNewYorkHarbor.csv', index=False, encoding='utf-8')
