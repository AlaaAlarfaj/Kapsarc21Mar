...
driver.get("https://www.eia.gov/dnav/pet/hist/RBRTED.htm")
...
#df = pd.DataFrame({'Price':AllPrices, 'Date':AllDates, 'Product':Product, 'Area':Area}) 
df = pd.DataFrame({'CrudeOilBrentEurope':AllPrices, 'Date':AllDates}) 
df.to_csv(r'C:/Users/User/Desktop/CrudeOilBrentEurope.csv', index=False, encoding='utf-8')
