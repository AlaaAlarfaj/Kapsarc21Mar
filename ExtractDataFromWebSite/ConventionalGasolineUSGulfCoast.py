...
driver.get("https://www.eia.gov/dnav/pet/hist/EER_EPMRU_PF4_RGC_DPGD.htm")


product="Conventional Gasoline"
area="U.S. Gulf Coast, Regular"
...
df.to_csv(r'C:/Users/User/Desktop/ConventionalGasolineUSGulfCoast.csv', index=False, encoding='utf-8')
