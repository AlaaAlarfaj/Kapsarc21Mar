...
driver.get("https://www.eia.gov/dnav/pet/hist/EER_EPJK_PF4_RGC_DPGD.htm")


product="Kerosene-Type Jet Fuel"
area="U.S. Gulf Coast"
...
df.to_csv(r'C:/Users/User/Desktop/KeroseneTypeJetFuelUSGulfCoast.csv', index=False, encoding='utf-8')
