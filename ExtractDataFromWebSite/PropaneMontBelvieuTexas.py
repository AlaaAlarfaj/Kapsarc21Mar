...
driver.get("https://www.eia.gov/dnav/pet/hist/EER_EPLLPA_PF4_Y44MB_DPGD.htm")


product="Propane"
area="Mont Belvieu, Texas"
...
df.to_csv(r'C:/Users/User/Desktop/PropaneMontBelvieuTexas.csv', index=False, encoding='utf-8')
