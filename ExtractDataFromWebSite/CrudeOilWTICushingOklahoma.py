...
driver.get("https://www.eia.gov/dnav/pet/hist/RWTCD.htm")


product="Crude Oil"
area="WTI - Cushing, Oklahoma"
...
df.to_csv(r'C:/Users/User/Desktop/CrudeOilWTICushingOklahoma.csv', index=False, encoding='utf-8')
